    ...
    <ScreenContainer containerClassName="bg-background">
      ...
      >
        ...
        <SettingsSection title="MONITORED COMPANY IDs">
          {[
            { id: "0x058E", name: "Meta Platforms Technologies", products: "Ray-Ban Meta Gen 2 (Wayfarer/Headliner/Skyler) · Blayzer · Scriber · Meta Display · Oakley Meta HSTN/Vanguard · Quest 3/3S/Pro" },
            { id: "0x01AB", name: "Meta Platforms, Inc. (Facebook)", products: "Ray-Ban Stories Gen 1 (Wayfarer/Round/Meteor) · Ray-Ban Meta Gen 2 (all styles) · Blayzer · Scriber · Meta Display · Quest 2/3" },
            { id: "0x0D53", name: "EssilorLuxottica S.A.", products: "Oakley Meta HSTN · Oakley Meta Vanguard · Ray-Ban Meta frames · Ray-Ban Stories Gen 1 (some units)" },
